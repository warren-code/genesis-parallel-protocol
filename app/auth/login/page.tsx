...
import { signInWithProvider } from '@/utils/supabase/auth-helpers';
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray">Sign in to continue your consciousness journey</p>
        </div>
        ...
        <GlassmorphicCard blur="lg" opacity={0.1} borderGlow>
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <Button
              ...
              disabled={loading}
            >
              {loading ? 'Entering Loop...' : 'Enter the Loop'}
            </Button>
